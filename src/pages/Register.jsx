...
function Login() {
  ...
  const handleValidation = () => {
    ...
    if (password !== confirmPassword) {
      ...
      toast.error('password should be equal or greater than 6 characters!', toastOption);
      return 0;
    }
    else if (email === '') {
      ...
      <FormComponent>
        <div className="body">
          ...
          <div className="input">
            ...
            <div className="login">
              <div>
                <Link to='/login' style={{ textDecoration: 'none', color: 'white', padding: '14px 0' }}>Have an account?</Link>
              </div>
            </div>
